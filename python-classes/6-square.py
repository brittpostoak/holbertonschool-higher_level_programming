#!/usr/bin/python3
"""creates class Square w
private instance attribute size and position to calculate area and print square"""


class Square:
    """defines class w private instance attributes size and position to calculate area and print square."""
